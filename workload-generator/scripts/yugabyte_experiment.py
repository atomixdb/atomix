...
def insert_rows(cursor, key_prefix, value_size, num_rows):
...
def main():
    ...
    for _ in range(num_iter):
        ...
        insert_rows(cursor, "a" + uuid_prefix, 100, num_rows_per_partition)
        insert_rows(cursor, "e" + uuid_prefix, 100, num_rows_per_partition)
        insert_rows(cursor, "n" + uuid_prefix, 100, num_rows_per_partition)
        insert_rows(cursor, "z" + uuid_prefix, 100, num_rows_per_partition)
